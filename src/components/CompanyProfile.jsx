...
const CompanyProfile = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      alert(
        "Ett fel uppstod när profilen skulle sparas. Se konsolen för detaljer."
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="profile-container">
        ...
        <div className="form-group">
          <label htmlFor="companyName">
            Företagets namn <span className="required">*</span>
          </label>
          <input
            type="text"
            id="companyName"
        ...
        <div className="form-group">
          <label htmlFor="email">
            Mailadress för kontakt <span className="required">*</span>
          </label>
          <input
            type="email"
            id="email"
